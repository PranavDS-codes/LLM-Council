...
import { Trophy, AlertTriangle, BarChart3, User, Clock, Hash, Cpu } from 'lucide-react';
                ...
                {activeTab === 'Overview' ? (
                    <div className="flex flex-col gap-4 animate-in fade-in duration-500">
                        ...
                        {currentSession?.metrics?.critic && (
                            <div className="pt-3 border-t border-[var(--border-base)] border-dashed flex items-center justify-end gap-4 text-[10px] uppercase font-mono text-[var(--text-muted)] opacity-80">
